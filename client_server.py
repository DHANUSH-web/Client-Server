...
class Client:
    ...
    def __init__(self, username, passcode):
        ...
        self.userData = "assets/user_data.txt"
    ...
    def deleteAccount(self):
        if self.isUser():
            ...
            if warning == "y":
                ...
                print(f"{Fore.CYAN}Your account successful deleted{Style.RESET_ALL}")
...
if __name__ == "__main__":
    ...
    if c.isCorrectUser():
        login = input(f"{Fore.CYAN}Sign-In/Register/Delete Account (s/r/d): ").lower()
...
'''
dhanushhv75@gmail.com
dHANUSHHV@12345

dhanushhv5@gmail.com
ENGINEERINGGURU@123
'''
